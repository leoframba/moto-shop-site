...
export const invoiceShellClass =
	"flex h-full flex-col overflow-hidden rounded-lg border border-neutral-700 bg-neutral-950";
...
export const invoiceHintClass =
	"mt-1.5 text-xs leading-relaxed text-neutral-400";

export const invoiceBodyMutedClass =
	"mb-3 text-xs leading-relaxed text-neutral-400";

export const invoiceFieldInputClass = `w-full ${invoiceFieldSurface} px-3 py-2.5 text-sm placeholder:text-neutral-400`;

export const invoiceFieldInputLgClass = `w-full ${invoiceFieldSurface} p-3 text-sm placeholder:text-neutral-400`;
...
export const invoiceTextareaClass = `h-48 w-full ${invoiceFieldSurface} p-3 text-sm leading-relaxed placeholder:text-neutral-400`;
...
export const invoicePrimaryButtonClass =
	"rounded-md bg-emerald-600 px-6 py-3 text-sm font-bold uppercase tracking-widest text-white transition-colors hover:bg-emerald-500 disabled:bg-neutral-700 disabled:text-neutral-400";
...
export const invoiceEmptyHintClass = "text-sm text-neutral-400";
